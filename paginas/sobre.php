...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Portal</b> do Aluno</a>
    </div>
    <div class="card-body">
      ...
      <form action="../../index3.html" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
              ...
              <br />
            <button type="submit" class="btn btn-primary btn-block text-center">Entrar</button>
      ...
      <div class="social-auth-links text-center mt-2 mb-3">
        ...
        <a href="#" class="btn btn-block btn-danger">
          <i class="fab fa-google-plus mr-2"></i> Entrar usandoGoogle+
        </a>
      </div>
      <!-- /.social-auth-links -->
